...
void lecturaCodigo(){
	...
	cout<<"-------INGRESA EL CODIGO A TRADUCIR-------"<<endl;
	cout<<"______________________________________________________"<<endl;
	cout<<"Para empezar a traducir el codigo ingresa 'tra()' y este se traducira de forma automatica"<<endl<<endl;
	while(linea.compare("tra()")!=0){
		getline(cin,linea,'\n');
		if(linea.compare("tra()")!=0){
			traducir(linea);
			traducir("\n");
		}
	}
